...
public class OrderHistoryRequestDTO {
    ...
    public OrderHistoryRequestDTO(String orderHistoryCode, Integer seq, LocalDateTime orderDate, OrderList orderList, String status) {
    ...
    public OrderHistory toEntity() {
        ...
        orderHistory.setOrderHistoryCode(orderHistoryCode);
